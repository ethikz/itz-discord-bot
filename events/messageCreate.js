/* eslint-disable no-console, consistent-return, global-require */
...
module.exports = {
   ...
   * message The message which was created.
   */
  ...
  async execute( message ) {
    ...
    /**
     * @type {String[]}
     * @description The Message Content of the received message seperated by
     * spaces (' ') in an array, this excludes prefix and command/alias itself.
     */
    ...
    // Will skip the permission check if command channel is a DM.
    // Use guildOnly for possible error prone commands!
