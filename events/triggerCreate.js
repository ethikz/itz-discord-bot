/* eslint-disable array-callback-return, no-console, consistent-return */
...
module.exports = {
  ...
  async execute( message ) {
    /**
     * @description The Message Content of the received message seperated by spaces (' ')
     * in an array, this excludes prefix and command/alias itself.
     */

    const args = message.content.split( / +/ );

    // Checks if the trigger author is a bot.
    // Comment this line if you want to reply to bots as well.
