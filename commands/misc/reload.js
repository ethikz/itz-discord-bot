/* eslint-disable consistent-return, no-console, import/no-dynamic-require, global-require */
...
module.exports = {
  ...
  execute( message, args ) {
    ...
    try {
      ...
      // Now registers the command in commands Collection.
      ...
      // Catch block executes if there is any error in your code.
      // It logs the error in console and also sends back in discord GUI.
